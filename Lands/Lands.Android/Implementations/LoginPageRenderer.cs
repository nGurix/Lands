...
[assembly: Xamarin.Forms.ExportRenderer(typeof(Lands.Views.LoginFacebookPage), typeof(Lands.Droid.Implementations.LoginPageRenderer))]

namespace Lands.Droid.Implementations
{
    public class LoginPageRenderer : PageRenderer
    {
        public LoginPageRenderer(Activity activity) : base(activity)
        {
            //var activity = Context as Activity;

            var auth = new OAuth2Authenticator(
                clientId: "945330678925307",
                scope: "email",
